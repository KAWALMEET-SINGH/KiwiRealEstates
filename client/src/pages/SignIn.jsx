...
const SignIn = () => {
  ...
  return (
    ...
    <div className={`p-4 max-w-xl mx-auto`}>
      ...
      <button disabled={loading} className={`bg-slate-700 text-white uppercase p-4 rounded-lg hover:opacity-95 disabled:opacity-75`} >{loading ? "Loading..." : "Sign In" }</button>
      </form>
